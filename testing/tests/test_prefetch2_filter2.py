...
class Tree_list_leaf_TestCase(TestCase):
    ...
    def test_tree_list(self):
        ...
        for tree in tree_qs:
            ...
            out = [(tree.name, tree.orgination, tree.branchesfrk.name, tree.branchesfrk.branchleafgroupfrk.groupLeafsName) for l in tree.branchesfrk.branchleafgroupfrk.groupleafs.all() if l.noOfpaper == 174 ]
